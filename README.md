This code makes use of python to create an To Do List app, that allows for the user to input various "To Do" Items and store it within variables in Python
